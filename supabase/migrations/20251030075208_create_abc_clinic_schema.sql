...
-- Policies for prescription_uploads
...
-- Policies for diagnostic_bookings
CREATE POLICY "Anyone can insert diagnostic bookings"
  ON diagnostic_bookings FOR INSERT
  TO anon
  WITH CHECK (true);

CREATE POLICY "Authenticated users can view diagnostic bookings"
  ON diagnostic_bookings FOR SELECT
  TO authenticated
  USING (true);

CREATE POLICY "Authenticated users can update diagnostic bookings"
  ON diagnostic_bookings FOR UPDATE
  TO authenticated
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Authenticated users can delete diagnostic bookings"
